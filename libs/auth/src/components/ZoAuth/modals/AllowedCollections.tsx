...
const AllowedCollectionModal: React.FC<AllowedCollectionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-20 p-4 bg-zui-white bg-opacity-60 flex items-center justify-center">
      ...
      <div className="max-h-[95vh] flex flex-col bg-zui-zui-dark relative max-w-md w-full">
        <div className="flex items-center justify-between p-4 flex-shrink-0">
          <h3 className=" text-lg mr-8 text-zui-pink font-semibold">
            PFP Collection Allowlist
          </h3>
          <button
            className="flex items-center bg-zui-white justify-center w-6 h-6 text-zui-white text-xl text-zui-zui-dark"
            onClick={close}
          >
