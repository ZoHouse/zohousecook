...
const alumniPageData: AlumniPageData = {
  ...
  curated: [
    ...
    },
    {
      ...
      mentorDescription: "Built India's largest hostel chain to $240M valuation (100+ properties). IIT BHU + IIM Calcutta. Tiger Global backed. Created the Zo World ecosystem.",
    },
    {
      name: "Lisa Ray",
      nickname: "lisaray",
      ...
      sector: "Creator Economy",
      mentorStack: true,
      mentorRole: "Actress · Author · Founder",
      mentorDescription: "India's first supermodel. Starred in Oscar-nominated Water. Beat multiple myeloma. Published Close to the Bone. Co-founded TheUpsideSpace (digital art platform).",
    },
    {
      ...
      mentorDescription: "Two-time cancer survivor turned India's top muralist. Netflix, JW Marriott, Hyundai, CRED, Reliance. TEDx speaker. Painted India's largest mural (24,000 sqft).",
    },
    {
      name: "Kratex",
      nickname: "kratex",
      ...
      mentorDescription: "Globalising Marathi music. First Marathi song on Spinnin' Records (20M+ streams). KSHMR remix. Remixed Asha Bhosle classics. Vogue India, Rolling Stone India. 340K+ following.",
    },
    {
      name: "Shabbir YK",
      nickname: "shabbiryk",
      ...
      sector: "Finance",
      mentorStack: true,
      mentorRole: "EAK Ventures · Web3 Investor",
      mentorDescription: "Web3 fund partner at EAK Ventures. Ex-CoinSwitch Ventures ($10M fund). Al-Thani Family Office, NVIDIA, Square. 40+ projects backed. 60+ investment memos.",
    },
  ],
  events: [
    {
  ...
  cta: {
    ...
    secondaryCta: { label: "Unlock Passport", href: "https://zozozo.work/passport" },
  },
};
