...
function BountyCardSkeleton() {
  return (
    <div className="relative flex flex-col overflow-hidden rounded-2xl border border-zui-stroke bg-zui-lighter">
      <div className="h-1 w-full bg-zui-stroke" />
      <div className="flex items-center justify-between border-b border-zui-stroke bg-zui-light/40 px-4 py-2">
        <div className="h-4 w-20 animate-pulse rounded-full bg-zui-light" />
        <div className="h-4 w-14 animate-pulse rounded-full bg-zui-light" />
      </div>
      <div className="flex flex-1 flex-col gap-4 p-6">
        <div className="flex items-start gap-3">
          <div className="h-12 w-12 shrink-0 animate-pulse rounded-lg bg-zui-light" />
          <div className="flex-1 space-y-2">
            <div className="flex gap-2">
              <div className="h-4 w-16 animate-pulse rounded-full bg-zui-light" />
              <div className="h-4 w-12 animate-pulse rounded-full bg-zui-light" />
            </div>
            <div className="h-4 w-3/4 animate-pulse rounded bg-zui-light" />
            <div className="h-4 w-1/2 animate-pulse rounded bg-zui-light" />
          </div>
        </div>
        <div className="space-y-2">
          <div className="h-3 w-full animate-pulse rounded bg-zui-light" />
          <div className="h-3 w-5/6 animate-pulse rounded bg-zui-light" />
        </div>
        <div>
          <div className="mb-1 flex items-center justify-between">
            <div className="h-3 w-20 animate-pulse rounded bg-zui-light" />
            <div className="h-3 w-12 animate-pulse rounded bg-zui-light" />
          </div>
          <div className="h-2 w-full animate-pulse rounded-sm bg-zui-light" />
        </div>
        <div className="flex items-center justify-between border-t border-dashed border-zui-stroke pt-3">
          <div className="h-5 w-24 animate-pulse rounded bg-zui-light" />
          <div className="h-6 w-20 animate-pulse rounded-full bg-zui-light" />
        </div>
      </div>
    </div>
  );
...
function BountyTableSkeleton() {
  return (
    <div className="overflow-hidden rounded-xl border border-zui-stroke bg-zui-lighter">
      <div className="h-12 border-b border-zui-stroke bg-zui-light/40" />
      {Array.from({ length: 6 }).map((_, i) => (
        <div
          key={i}
          className={`flex items-center gap-4 px-5 py-4 ${
            i !== 5 ? "border-b border-dashed border-zui-stroke" : ""
          }`}
        >
          <div className="h-8 w-1.5 shrink-0 animate-pulse rounded-full bg-zui-light" />
          <div className="flex-1 space-y-1.5">
            <div className="h-4 w-3/4 animate-pulse rounded bg-zui-light" />
            <div className="h-3 w-1/2 animate-pulse rounded bg-zui-light" />
          </div>
          <div className="h-5 w-16 animate-pulse rounded-full bg-zui-light" />
          <div className="hidden h-5 w-20 animate-pulse rounded-md bg-zui-light md:block" />
          <div className="h-3 w-20 animate-pulse rounded bg-zui-light" />
          <div className="h-5 w-16 animate-pulse rounded bg-zui-light" />
          <div className="hidden h-3 w-14 animate-pulse rounded bg-zui-light sm:block" />
        </div>
      ))}
    </div>
  );
...
function EventBannerSkeleton() {
  return (
    <div
      className="relative overflow-hidden rounded-xl border border-zui-stroke bg-zui-lighter"
      style={{ aspectRatio: "9 / 16" }}
    >
      <div className="absolute inset-0 animate-pulse bg-gradient-to-b from-zui-light/40 via-zui-light/60 to-zui-light/30" />
      <div className="absolute right-3 top-3 flex flex-col items-end gap-1.5">
        <div className="h-4 w-16 animate-pulse rounded-full bg-zui-light/80" />
        <div className="h-3 w-14 animate-pulse rounded bg-zui-light/80" />
      </div>
      <div className="absolute inset-x-0 bottom-0 border-t border-zui-stroke bg-zui-lighter px-4 py-3">
        <div className="mb-2 h-4 w-3/4 animate-pulse rounded bg-zui-light" />
        <div className="flex items-center justify-between">
          <div className="h-3 w-16 animate-pulse rounded bg-zui-light" />
          <div className="h-6 w-6 animate-pulse rounded-full bg-zui-light" />
        </div>
      </div>
    </div>
  );
