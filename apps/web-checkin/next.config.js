...
console.log(`[INFO] NEXT_PUBLIC_RECAPTCHA_KEY: ${process.env.NEXT_PUBLIC_RECAPTCHA_KEY}`);
...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "img.cdn.zostel.com",
      },
      {
        protocol: "https",
        hostname: "img-staging.cdn.zostel.com",
      },
      {
        protocol: "https",
  ...
  env: {
    ...
    ZOSTEL_WEB_URL: process.env.NEXT_PUBLIC_ZOSTEL_WEB_URL || "",
  },
  transpilePackages: [
    "gsap",
    "antd",
