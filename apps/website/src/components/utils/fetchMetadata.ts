...
export const fetchMetaData: GetServerSideProps = async (context) => {
  ...
  const currentUrl = `${process.env.WEB_BASE_URL}${resolvedUrl}`;

  const defaultMetaData = {
    title: "A brave new world!",
    description:
      "A place to vibe in every corner of the world. A local friend, everywhere. Connect from anywhere. Welcome to Zo World!",
    image: `${process.env.MEDIA_BASE_URL}/gallery/media/images/c4a6a760-f7c4-4627-bd82-05ac00fb16d6_20240917082703.jpg`,
  };
