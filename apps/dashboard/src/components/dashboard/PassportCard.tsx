...
export function PassportCard() {
  ...
  return (
    <GlassCard
      className="p-dash-xl flex flex-col items-center"
      onClick={() => router.push("/passport")}
    >
      <h3 className="text-sm font-medium text-dash-text-50 uppercase tracking-wider mb-dash-lg self-start">
        Zo Passport
      </h3>

      {/* Passport card */}
      <div
        className="relative w-full max-w-[234px] h-[300px] rounded-[20px] overflow-hidden"
        style={{
          boxShadow: isFounder
