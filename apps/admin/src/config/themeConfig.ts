...
const _theme: ThemeConfig = {
  ...
  components: {
    ...
    Button: {
      colorPrimary: "#cfff50",
      colorPrimaryHover: "#daff7a",
      colorPrimaryActive: "#b8e646",
      colorTextLightSolid: "#000000", // Change text color to black for better contrast with neon background
      primaryColor: "#cfff50",
      defaultBg: "transparent",
      defaultBorderColor: "#cfff50",
      defaultColor: "#cfff50",
    },
  },
  algorithm: theme.darkAlgorithm,
